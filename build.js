...
let HTML_PREVIEW_URL = process.env.HTML_PREVIEW_URL || 'https://html-preview-simple.netlify.app/';
...
if (HTML_PREVIEW_URL && !HTML_PREVIEW_URL.startsWith('http') && !HTML_PREVIEW_URL.startsWith('/') && !HTML_PREVIEW_URL.startsWith('.')) {
